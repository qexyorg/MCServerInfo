...
$connect = MCServerInfo::Connect($config['address'], $config['port'], $config['timeout'])->setMethod(MCServerInfo::METHOD_QUERY);
...
<html lang="en">
<head>
	<title>Query | Examples | MCServerInfo</title>
...
<?php $active = 'query'; require_once('./navbar.php'); ?>

<div class="container">
	<div class="pt-100">
		<div class="text-center">
			<h2 class="text-gray">Query method</h2>
		</div>
	</div>
	...
	<?php if($status == 'online'){ ?>
		...
		<div class="pt-20">
			<div class="bb-code">
				...
				<div class="bb-code-text w-space-pre-wrap">
					<div class="of-auto" style="max-height:300px;">
						$connect = MCServerInfo::Connect('<?php echo $config['address']; ?>', <?php echo $config['port']; ?>, <?php echo $config['timeout']; ?>)->setMethod(MCServerInfo::METHOD_QUERY);
